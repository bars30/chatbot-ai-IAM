export const botEnReplies = {
  ...
  "Technological Expertise & Roles" : `
    ...
    <p><b>Key IAM & Cybersecurity Roles We Place</b><br>Our expertise spans the critical positions driving your Identity and Access Management and Cybersecurity initiatives:</p>
    <ul>
  ...
  "Team" : `
    ...
    <div class="space"></div>
  `, 
  "For IAM Professionals" : `
    <h2>For IAM Professionals: Your Next Career Move Starts Here</h2>
    <p>As a leading specialized IAM and Cybersecurity recruiter in Germany and DACH, we're dedicated to connecting top talent like you with rewarding career opportunities at innovative companies. Let us help you navigate your next career move, whether you're an IAM Engineer, Architect, or PAM Specialist.</p>
    <h2>Why Partner With IAM Hiring?</h2>
    We're trusted by top talents who seek meaningful career progression, not just another job. We understand your expertise in Okta, SailPoint, CyberArk, and Azure AD, and we match you with roles that truly fit.</p>
    <ul>
      <li>
  ...
  `,
  "Contact" : `
    <p>Ready to find your next IAM expert for your Banking, Tech, or Manufacturing enterprise, or looking for your next career opportunity in IAM/Cybersecurity? Get in touch with our specialized team today.</p>
